...
public class BLESwitchService extends Service {
    private final static String TAG = BLESwitchService.class.getSimpleName();
    ...
    public class LocalBinder extends Binder {
        BLESwitchService getService() {
            return BLESwitchService.this;
        }
    }
    ...
    public void turnSwitch(int index, boolean state) {
        byte commandByte = (byte)0x99;
        if (index==0) {
            commandByte = state? (byte)0x04 : (byte)0x06;
        } else if (index==1){
            commandByte = state? (byte)0x05 : (byte)0x07;
